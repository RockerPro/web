...
if($_POST) {
    ...
    $cabeceras = "From: $subscriber_email \n" //La persona que envia el correo
 . "Reply-To: $subscriber_email \n";
    if(!isEmail($subscriber_email)) {
        $array = array();
        $array['valid'] = 0;
        $array['message'] = 'Por favor ingrese un correo valido!';
        echo json_encode($array);
    }
    else {
        $array = array();
        $array['valid'] = 1;
        $array['message'] = 'Gracias por Suscribirte!';
        echo json_encode($array);

        // Send email
	    $subject = 'Nuevo suscriptor (SGTEL)!';
	    $body = "Usted tiene un nuevo suscriptor!\n\nEmail: " . $subscriber_email;
