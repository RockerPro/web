		...
		<main class="cd-main-content">
			...
			<div class="col-md-12">
      				<div class="col-md-6 contvalor wow fadeIn" data-wow-delay="0.1s">
      					<img src="<?php echo $baseurl ?>/dist/img2/apps/soluciona.png" class="img-responsive"
      					style="margin:0 auto;margin-top: 30px;" alt="soluciona">
      				</div>
	            <div class="col-md-6 contcli" data-wow-delay="0.3s">
                    ...
                    <p class="conttext2  wow fadeInUp" data-wow-delay="0.6s" style="text-align: justify;">
                    	Los problemas domésticos tendrán una solución de manera inmediata 
                    	y confiable, pues con Solussiona podrás solicitar la atención de un 
                    	técnico especializado que esté cercano a la vivienda que genere la alerta.
						Asimismo, los técnicos serán notificados de manera inmediata cuando un 
						cliente solicite de sus servicios. <br>
						Los técnicos que atiendan la alerta, habrán pasado ya por un riguroso 
						proceso de selección, el cual garantiza que la calidad del servicio sea la mejor. <br>
						Todo ello, se podrá gestionar mediante un portal web, que a su vez te 
						permitirá generar los reportes necesarios para tomar buenas decisiones
                    </p>                                  
	            </div>
	            <div class="col-md-12 contcli" data-wow-delay="0.3s">
                    <div class="wow fadeInUp">
                    	...
                    	<ul class="conttext2  wow fadeInUp" data-wow-delay="0.6s">
							<li>Nuevo canal de publicidad.</li>
					        <li>Acceso a la información de tu público objetivo.</li>
					        <li>Tecnología Cloud.</li>
					        <li>Integración de toda la cadena de valor de la organización</li>
					        <li>Diferenciación y valor agregado para tus clientes.</li>
					        <li>Disminución de gastos en publicidad.</li>
					        <li>Hiper segmentación de clientes.</li>
					        <li>Entre otros.</li>
						</ul><br>
						<h3>Clientes</h3>
                    	<ul class="conttext2  wow fadeInUp" data-wow-delay="0.6s">
							<li>Menor tiempo de espera para la solución de un problema doméstico.</li>
					        <li>Técnicos especializados en su rubro.</li>
					        <li>Técnicos especializados.</li>
					        <li>Amplia gama de servicios disponibles: Carpintería, albañilería, electricidad, pintura, cerrajería, gasfitería, entre otros. </li>
					        <li>Programación de obras.</li>
					        <li>Búsqueda de técnicos por ubicación.</li>
						</ul><br>
						<h3>Técnicos</h3>						
						<ul class="conttext2  wow fadeInUp" data-wow-delay="0.9s">
							<li>Más clientes.</li>
        					<li>Acceso a formación en nuevos productos y técnicas.</li>
        					<li>Descuentos en los principales almacenes del país.</li>
						</ul><br>                                   
	            </div>
	            <div class="col-md-12 contcli" data-wow-delay="0.3s">
                    <div class="wow fadeInUp">
                    	<p class="titsec"  style="width:250px;">OTROS USOS DE LA APLICACIÓN</p>
	                    <div class="divider divider_gray ">
	                               		<span></span><span></span>
	                    </div>
                    </div>
                    	<ul class="conttext2  wow fadeInUp" data-wow-delay="0.6s">
							<li>Help desk y soporte técnico.</li>
							<li>Empresas de taxi.</li>
							<li>Empresas con servicio de delivery.</li>
							<li>Búsqueda de personas.</li>
							<li>Localización de proveedores.</li>
							<li>Entre otras.</li>
						</ul><br>                                  
	            </div>				
			</div>	
