  ...
  <div id="main" ng-app="app">
    ...
    <main class="cd-main-content">
      <div class="col-md-9" style="margin-top: 55px;margin-bottom:25px;overflow: hidden;">
        <div class="col-md-12">         
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="contvalor wow fadeIn" data-wow-delay="0.3s" style="margin-top: 0px;">
                        <img src="<?php echo $baseurl?>dist/img2/banners/banner-9.jpg" class="img-responsive" alt="TECNOLOGIA SGTEL">    
                  </div>
                  <p class="conttext2 wow fadeInUp" data-wow-delay="0.9s">
                  Actualmente, el marketing digital forma una de las piezas claves para cualquier estrategia 
                  empresarial, pues con este nuevo canal se puede exponer las marcas de manera más efectiva y 
                  sin tener que contar con altos presupuestos.
                  En SGTEL, brindamos soluciones creativas a medida que te permitan llegar a tus objetivos, 
                  mediante la creación de un ecosistema digital donde podrás darte a conocer, conseguir  más 
                  clientes (que se traducen en mayores ingresos), fidelizar a tus clientes, proponerles 
                  productos o servicios que se adecuen a sus necesidades, obtener feedback de primera mano 
                  para las mejoras de los mismos, entre otros servicios.
                  </p>
                  <div class="col-md-12">
                    <div class="col-md-5">
                      <div class="contvalor wow zoomIn" data-wow-delay="1.2s">
                        <p class="how">¿Cómo lo hacemos?</p>
                      </div>
                       <p class="conttext2 wow fadeInUp" data-wow-delay="1.5s">
                      Mediante una plan de marketing digital que esté alineado con los planes 
                      de la organización para ello utilizamos la estrategia de atracción de 
                      clientes (Inboud marketing). </p>
                    </div>
                    <div class="col-md-7 wow zoomIn" data-wow-delay="1.8s">
                      <img class="img-responsive inboud" 
                      src="<?php echo $baseurl?>dist/img2/inboud.png" 
        ...
        <div id="ecommerce" class="col-md-12" style="margin-top:55px;">         
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="contvalor wow fadeIn" data-wow-delay="0.3s" style="margin-top: 0px;">
                        <img src="<?php echo $baseurl?>dist/img2/banners/banner-10.jpg" class="img-responsive" alt="TECNOLOGIA SGTEL">    
                  </div>
                  <p class="conttext2 wow fadeInUp" data-wow-delay="0.9s">
                  Establece los objetivos y nosotros te ayudamos a realizarlos en el 
                  mundo virtual, mediante el diseño y  la implementación de una web 
                  comercial amigable, o en todo caso mejorar la plataforma que ya tienes. <br>
                  En SGTEL, expandimos tus canales de comercialización para que generes 
                  mayores ingresos desarrollando estrategias que te permitan estar donde 
                  tu público meta se encuentra y exponiendo tu negocio a nuevos mercados 
                  internacionales.
                  </p>
                  <div class="col-md-12">
                    <div class="col-md-6">
                      <div class="contvalor wow zoomIn" data-wow-delay="1.2s">
                        <p class="how">POR ELLO TE OFRECEMOS</p>
                      </div>
                       <ul class="conttext2 wow fadeInUp" data-wow-delay="0.9s" style="padding-left:20px;text-align: left;">
                        <li>Desarrollo de plataformas de Ecommerce</li>
                        <li>Diseño web responsive</li>
                        <li>Gestión en redes sociales</li>
                        <li>Posicionamiento SEO y SEM</li>
                        <li>Desarrollo de publicidad en las redes sociales</li>
                        <li>Desarrollo de soluciones móviles ecommerce</li>
                        <li>Entre otros servicos</li>
                       </ul>
                    </div>
                    <div class="col-md-6 wow zoomIn" data-wow-delay="1.8s">
                      <img class="img-responsive ecommerce" 
                      src="<?php echo $baseurl?>dist/img2/ecommerce.png" 
                      alt="con sgtel enamora a los clientes">
                    </div>
                  </div>
